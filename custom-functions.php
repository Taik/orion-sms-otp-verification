...
if ( ! function_exists( 'ihs_generate_translated_msgs' ) ) {
	...
	function ihs_generate_translated_msgs() {
		$ihs_wpml_messages = array(
			'mobile_box_label'   => __( 'Mobile Number with Country Code (required)', 'orion-sms-otp-verification' ),
			'otp_required'       => __( 'OTP( required )', 'orion-sms-otp-verification' ),
			'send_otp'           => __( 'Send OTP', 'orion-sms-otp-verification' ),
			'otp_verify_label'   => __( 'Enter Verification Code sent', 'orion-sms-otp-verification' ),
			'verify_otp'         => __( 'Verify OTP', 'orion-sms-otp-verification' ),
			'resend_otp'         => __( 'Resend OTP', 'orion-sms-otp-verification' ),
			'reset_pwd_via_otp'  => __( 'Reset Password via OTP', 'orion-sms-otp-verification' ),
			'mobile_no_required' => __( 'Mobile Number (required)', 'orion-sms-otp-verification' ),
			'send_new_password'  => __( 'Send New Password', 'orion-sms-otp-verification' ),
			'sending'            => __( 'Sending...', 'orion-sms-otp-verification' ),
			'sending_otp'        => __( 'Sending OTP...', 'orion-sms-otp-verification' ),
			'verifying'          => __( 'Verifying...', 'orion-sms-otp-verification' ),
			'ok'                 => __( 'OK', 'orion-sms-otp-verification' ),
			'reset_password'     => __( 'Reset Password', 'orion-sms-otp-verification' ),
			'alerts'             => array(
				'pls_verify_otp_first'   => __( 'Please verify OTP first', 'orion-sms-otp-verification' ),
				'pls_enter_req_field'    => __( 'Please Enter the required fields', 'orion-sms-otp-verification' ),
				'pls_enter_otp'          => __( 'Please Enter OTP', 'orion-sms-otp-verification' ),
				'thx_for_verification'   => __( 'Thank you for verification', 'orion-sms-otp-verification' ),
				'otp_enter_incorrect'    => __( 'OTP Entered is Incorrect', 'orion-sms-otp-verification' ),
				'tried_too_many_times'   => __( 'You have tried too many times', 'orion-sms-otp-verification' ),
				'otp_sent_to_mobile'     => __( 'OTP sent to your mobile', 'orion-sms-otp-verification' ),
				'enter_mobile_no'        => __( 'Enter the mobile number', 'orion-sms-otp-verification' ),
				'enter_crt_mobile_no'    => __( 'Enter the correct Mobile Number', 'orion-sms-otp-verification' ),
				'enter_country_code'     => __( 'Enter the Country Code', 'orion-sms-otp-verification' ),
				'verification_incorrect' => __( 'Verification code is incorrect', 'orion-sms-otp-verification' ),
				'error_try_again'        => __( 'Error: Please try again', 'orion-sms-otp-verification' ),
				'sending_new_pass'       => __( 'Sending new password...', 'orion-sms-otp-verification' ),
				'new_pass_sent'          => __( 'New password sent to your mobile', 'orion-sms-otp-verification' ),
			),
		);
	...
	function ihs_otp_send_new_pass() {
		...
		if ( ! empty( $user_obj ) ) {
			...
			if ( $response ) {
				...
				$error_msg = __( 'Message Not Sent', 'orion-sms-otp-verification' );
			}
		} else {
			// user not found
			$error_msg = __( 'User Not found', 'orion-sms-otp-verification' );
		}
